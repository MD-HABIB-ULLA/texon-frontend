    ...
    <div className="max-w-screen-xl mx-auto py-10">
      <div className="px-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* 1 Card */}
          <div className="relative flex flex-col items-center rounded-lg bg-white w-full group">
            <div className="flex flex-col items-center p-5">
              <Image
                src={web}
                alt="web"
                className="rounded-t-lg group-hover:opacity-0 transition-opacity duration-300 -mt-20"
              />
          ...
          {/* 2 Card */}
          <div className="relative flex flex-col items-center rounded-lg bg-white w-full group mt-20 md:mt-0 lg:mt-0">
            <div className="flex flex-col items-center p-5">
              <Image
                src={mobile}
                alt="Phone"
          ...
          {/* 4 Card */}
          <div className="relative flex flex-col items-center rounded-lg bg-white w-full group mt-20">
            <div className="flex flex-col items-center p-5">
              <Image
                src={automation}
                alt="automation"
