      ...
      <div className="max-w-screen-xl mx-auto px-4 py-36 flex flex-col lg:flex-row lg:space-x-12">
        ...
        <div className="space-y-7 lg:w-2/3">
          ...
          <p className="text-gray-700">
            ...
            you want to sell your products or services to millions of customers{" "}
            around the world? If yes, then you need our readymade ecommerce{" "}
            website and app solution!
          </p>
        </div>
        ...
        <div className="w-full lg:w-1/3">
          <form className="space-y-4">
            <h2 className="font-semibold text-xl mb-4">Get Started with Your Free Demo</h2>
            <div>
              <input
                type="text"
