...
export default function ProductBanner() {
  return (
    <div className="max-w-screen-xl mx-auto px-4 py-10 md:py-16 lg:py-40 flex flex-col lg:flex-row lg:space-x-12 text-charleston">
      {/* Text Section */}
      <div className="space-y-5 md:space-y-7 lg:w-2/3">
